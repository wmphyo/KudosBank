const questionsSets = [
    [
        ...
        options: [
            "A. a policy stating the United States would not recognize any territory gained by aggression",
            "B. a policy stating the United States would come to the aid of any country attacked without provocation by another country",
            "C. a policy stating that the United States would continue to look for opportunities to expand their influence throughout the world",
            "D. a policy stating that the United States would take no action when there were disputes between countries in Europe or Asia"
        ],
        answer: "A",

const claimsEvidencePracOneAnswers = [
    ["C",
        [
            "Explanation: If one version of a trait provides no advantage over the other, no change in the proportions will be observed. Because the proportion of dark to light fish remained about the same over time, the ecologists can assume that no selection occurred because there is no differential survivability."
        ]
    ],
    ["A",
        [
            "Explanation: A change in the dependent variable shows that natural selection is occurring. In the peppered moths example, the dependent variable is the proportion of dark- and light-winged moths observed. Because these proportions changed over time, natural selection was occurring."
        ]
    ],
    ["B",
        [
            "Explanation: Scientists believe that the universe formed as the result of a giant explosion termed the Big Bang."
        ]
    ],
    ["C",
        [
            "Explanation: Statement I addresses the first reason presented in the passage—as yet there has been no study on human beings —and provides you with a study that supports the initial findings with new findings on human subjects. Statement II addresses the second reason presented in the passage—there has been no long-term study as of yet—by providing information from a long-term study of cancer cells exposed to microwaves. Statement III, however, focuses on people who have been exposed to X-rays, rather than microwaves. Since this study does not relate to microwaves, the results would not lend any weight to the initial results described in the passage. Thus, I and II, but not III, support the initial results, and the correct answer is (C)."
        ]
    ],
    ["B",
        [
            "Explanation: Asteroids are composed of rock, and comets are composed of frozen gas and dust. Identifying the composition of the object will tell scientists what type of object it is."
        ]
    ],
];
...
const variablePracOneAnswers = [
    ...
    ["A",
        [
            "Explanation: The independent variable is a variable that is changed by the researcher. So, since the CO2 pressure is being changed in this experiment while the other choices are not. So, the independent variable is CO2 pressure."
        ]
    ],
    ["A",
        [
            "Explanation: A dependent variable is one that changes in response to the independent variable(s) in an experiment. The independent variable is a variable that is changed by the researcher.In this experiment, the amount of bubbles produced was the dependent variable. The amount of bubbles produced depended on the independent variable, which was the amount of light that each leaf received.The amount of water in each beaker and the number of leaves in each beaker were not considered variables because both were held constant."
        ]
    ],
    ["C",
        [
            "Explanation: Group 2 was the experimental group, and Group 1 was the control group. The control group is the one that is not exposed to the variable that is being tested (the potential new drug); therefore, Group 1 is the control group because its members received fake pills instead."
        ]
    ],
    ["B",
        [
            "Explanation: The independent variable of the experiment was the position of the fish in the tank, and the dependent variable was the carbon dioxide level in each tank."
        ]
    ]
];
...
function pageCheck(){
    ...
    if(window.location.href.includes('claims-and-evidence-1')){
        ...
        correctAnsArr = conclusionPracTwoAnswers;
    } else if (window.location.href.includes('conclusion-3')){ 
        correctAnsArr = conclusionPracThreeAnswers;
    ...
    } else if (window.location.href.includes('improve-reliability-of-experiments-1')){
        correctAnsArr = reliabilityPracOneAnswers;
    } else if (window.location.href.includes('improve-reliability-of-experiments-2')){
        correctAnsArr = reliabilityPracTwoAnswers;
    } else if (window.location.href.includes('improve-reliability-of-experiments-3')){

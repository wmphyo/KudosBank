const questionsSets = [
    [
        ...
        },
        {
            ...
            answer: "C",
            explanation: "Explanation: A. Place all strawberries into the same plastic bag<br><br> B. Place the bags in different locations, rather than in the same location<br><br> C. Set up the experiment in triplicate<br><br> D. Wait to record observations until seven days after adding the strawberries and yeast to the bags.The best way to improve the design of the experiment is to set up the experiment in triplicate. By testing three strawberries under each of the three conditions being tested, the researchers will have more reliable data<br><br>Placing the strawberries in different locations will not improve the design of the experiment because this represents an additional variable. Placing all strawberries into the same bag would represent a bad experimental design, because it no longer allows the researcher to compare the differences in decomposition for a strawberry exposed to no yeast, a teaspoon of yeast, or a tablespoon of yeast. That is, all three strawberries would be exposed to the same conditions if they were all in the same bag together.<br><br> Recording observations after just three days, rather than five, does not improve the experiment. This allows less time for decomposition to occur, so it will probably provide less reliable results than the original design of recording observations after five days."
        },
        {
